...
from src.database.data_access.queries.queries import get_withdrawal_ranking_2, get_withdrawal_transactions_2
...
with st.spinner('データを取得中...'):
    ...
    withdrawal_transactions_df = get_withdrawal_transactions_2(st.session_state.db_client)
