...
def create_doll_nft_transactions(db_client: DatabaseClient) -> None:
    create_table_query = """
    CREATE TABLE IF NOT EXISTS doll_nft_transactions (
    ...
    CREATE INDEX IF NOT EXISTS idx_dnt_timestamp ON doll_nft_transactions(timestamp);
    """
    db_client.execute(create_index_timestamp_query)
        

    create_index_from_address_query = """
    CREATE INDEX IF NOT EXISTS idx_dnt_from_address ON doll_nft_transactions(from_address);
    """
    ...
    CREATE INDEX IF NOT EXISTS idx_dnt_to_address ON doll_nft_transactions(to_address);
    """
...
def insert_doll_nft_transactions(db_client: DatabaseClient, transactions: list) -> int:
    ...
    INSERT INTO doll_nft_transactions (block_number, log_index, tx_hash, timestamp, from_address, to_address, token_id, method, type)
