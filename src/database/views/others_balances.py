...
def create_vw_others_balances(client: DatabaseClient) -> None:
    ...
    create_view = """
    CREATE OR REPLACE VIEW vw_others_balances AS
    ...
    print("vw_others_balancesを作成しました。")
        


if __name__ == "__main__":
    create_vw_others_balances(DatabaseClient())