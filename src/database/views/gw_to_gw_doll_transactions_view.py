...
def create_gw_to_gw_doll_transactions_view() -> None:
    client = DatabaseClient()
    client.execute("DROP VIEW IF EXISTS gw_to_gw_doll_transactions")
    ...
    print("gw_to_gw_doll_transactionsビューを作成しました。")
        


if __name__ == "__main__":
    create_gw_to_gw_doll_transactions_view()
